...
void dl_kr() {
    ...
    if (r > 0)
    {
        cout << "Длина окружности равна " << 2 * 3.14159265358979323846 * r << endl;
    }
    else
    {
...
void pl_kr() {
    ...
    if (r > 0)
    {
        cout << "Площадь окружности равна " << 3.14159265358979323846 * pow(r, 2) << endl;
    }
    else
    {
        cout << "Радиус не может быть отрицательным" << endl;
...
void pisec_kr() {
    ...
    cin >> rad;
    if (r > 0 & rad > 0 & rad <= 360)
    {
        cout << "Площадь кругового сектора равна " << (rad / 2) * pow(r, 2) << endl;
    }
    else
    {
        cout << "Радиус не может быть отрицательным или угол кругового сектора больше 360" << endl;
    }
}
